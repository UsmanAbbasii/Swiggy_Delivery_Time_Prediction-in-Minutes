...
docker run -d -p 80:8000 --name delivery_time_pred -e DAGSHUB_USER_TOKEN=05ee39ac16d1a6eaf382144527ea4ba2a9ba05bfa 211125723562.dkr.ecr.ap-south-1.amazonaws.com/food_delivery_time_pred:latest
